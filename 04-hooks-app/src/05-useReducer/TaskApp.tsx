...
export const TasksApp = () => {
  ...
  useEffect(() =>{
    // ? el localstorage pide 2 cosas, una key, que puede ser identificador que sea xd
    // ? y otro el value, que en este caso es el staet, pero lo convertimos a un JSON.stringify(state)

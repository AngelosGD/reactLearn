...
export const TrafficLightWithEffect = () => {
  ...
  // ! se recomienda tener efectos atomicos, es decir en este caos 2 diferentes, uno para el countodwn y otro para cambiar de luces
  // ! no tener ningun efecto de varias funciones o fines D:
